...
//this function loops html table to fetch transactions then fill the pos-data object
$('#btn-print-pos').click(function(){
  ...
  // fetching sample data from html
...
//creates the data obj for the pos-printer
  function printData() {
  let data = [
        {
        ...
        {
          type: "text", // 'text' | 'barCode' | 'qrCode' | 'image' | 'table
          value: "nirdteq,inc &copy; free to copy",
